...
public class Main {
	...
	Date: 2020/04/13
	Description: Build a program that uses different methods to Convert from ºC to ºF, ºF to ºC , K to ºC, ºC to K
	 */
    ...
    public static void f_menu() {
        ...
        System.out.println("------------------------");
        System.out.println("|     Soft convert     |");
    ...
    public static int f_kind_from_grades() {
        // Description: this method input the kinds of grades
    ...
    public static int f_kind_to_grades(int kind_from) {
        ...
        System.out.println("input of the kind  do you want convert of grades: \n1 - celsius\n2 -fahrenheit\n3 - kelvin");
        Scanner keyboard = new Scanner(System.in);
        int opt = keyboard.nextInt();
        if (opt == 1 || opt == 2 || opt == 3) {
            if (opt == kind_from) {
    ...
    public static void f_convert(int kind_from, int kind_to){
        ...
        }else if (kind_from==1 && kind_to==2) {  // convert celsius to kelvin K = ºC + 273.15
