...
public class Main {
	...
	Date: 2020/05/06
	Description: This software ask N number of people's names and determine how may names have the letter "a" and how may have the letter "e"
	 */
    ...
    public static void f_show_letter_a(String[] vector_name) {
        //Description: This method cunts the names that have the letter  a
        int total_words = 0;
